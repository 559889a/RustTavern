...
const aiRoutesSource = await readFile(new URL('../src/host/main/routes/ai-routes.js', import.meta.url), 'utf8');
const rustSource = await readFile(new URL('../crates/tt-domain/src/models/chat_completion_source.rs', import.meta.url), 'utf8');
const rustConfigSource = await readFile(new URL('../crates/tt-application/src/services/chat_completion_service/config.rs', import.meta.url), 'utf8');
const rustPayloadSource = await readFile(new URL('../crates/tt-application/src/services/chat_completion_service/payload/minimax.rs', import.meta.url), 'utf8');
const rustRepositorySource = await readRustSources(new URL('../crates/tt-adapter-provider-http/src/http_chat_completion_repository/', import.meta.url));
