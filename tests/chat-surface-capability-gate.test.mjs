...
import { assertRequiredChatSurfaceParticipants } from '../src/host/main/services/chat-surface/capability-gate.js';
import { getChatSurfaceParticipantRegistry } from '../src/host/main/services/chat-surface/runtime.js';
