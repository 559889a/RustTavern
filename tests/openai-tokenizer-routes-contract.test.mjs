...
import { createTokenCountBroker } from '../src/host/main/brokers/token-count-broker.js';
import { registerOpenAiTokenizerRoutes } from '../src/host/main/routes/openai-tokenizer-routes.js';

test('OpenAI token prefix count command is part of the centralized invoke contract', async () => {
    const source = await readFile(new URL('../src/host/main/kernel/invokes/host-commands.js', import.meta.url), 'utf8');
