...
import { CHAT_SURFACE_PROTOCOL_VERSION } from '../src/host/main/services/chat-surface/participant-registry.js';
...
test('ChatSurface exposes only the three raw Project API members', async () => {
    ...
    const source = await readFile(path.join(REPO_ROOT, 'src/host/main/api/chat-surface.js'), 'utf8');
