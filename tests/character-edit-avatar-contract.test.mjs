...
import { textResponse, jsonResponse } from '../src/host/main/http-utils.js';
import { resolveHostErrorResponse } from '../src/host/main/kernel/host-error-response.js';
import { createRouteRegistry } from '../src/host/main/router.js';
import { registerCharacterRoutes } from '../src/host/main/routes/character-routes.js';
import { createCharacterService } from '../src/host/main/services/characters/character-service.js';
import {
    CHARACTER_CREATE_WARNINGS,
    createCharacterCreateService,
} from '../src/host/main/services/characters/character-create-service.js';
import { formDataToCreateCharacterDto, payloadToCreateCharacterDto } from '../src/host/main/services/characters/character-create-mapper.js';
import { createCharacterFormService } from '../src/host/main/services/characters/character-form-service.js';
