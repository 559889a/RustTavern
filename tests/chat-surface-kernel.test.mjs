...
import { createChatProjection } from '../src/host/main/kernel/chat-surface/projection.js';
import { createStructureSnapshotFactory } from '../src/host/main/kernel/chat-surface/structure-snapshot.js';
import { createBoundedProjectionLayout } from '../src/host/main/kernel/chat-surface/projection-layout.js';
