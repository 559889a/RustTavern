...
import { registerTtsRoutes } from '../src/host/main/routes/tts-routes.js';
...
test('tts host route stays a backend-command adapter', async () => {
    const source = await readFile(new URL('../src/host/main/routes/tts-routes.js', import.meta.url), 'utf8');
