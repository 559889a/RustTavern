...
const agentSystemCacheInputs = [
  ...
  ...listJavaScriptFiles('src/scripts/rusttavern/agent'),
];

const hostSettingUiCacheInputs = [
  ...commonCacheInputs,
  ...listJavaScriptFiles('src/scripts/app/setting/settings-app'),
  ...listJavaScriptFiles('src/scripts/app/setting/dev-logs-app'),
  ...listJavaScriptFiles('src/scripts/app/setting/sync-app'),
];
...
const rustTavernSettingsConfig = {
  name: 'rusttavern-settings',
  dependencies: ['vendor-libs'],
  mode: 'production',
  bail: true,
  target: ['web', 'es2020'],
  cache: createPersistentCache('rusttavern-settings', hostSettingUiCacheInputs),
  entry: {
    settings: './src/scripts/app/setting/settings-app/index.js',
    'dev-logs': './src/scripts/app/setting/dev-logs-app/index.js',
    sync: './src/scripts/app/setting/sync-app/index.js',
  },
  output: {
    filename: '[name].bundle.js',
    path: path.resolve(__dirname, 'src/scripts/app/setting/dist'),
    module: true,
    library: {
      type: 'module'
    },
...
export default [coreConfig, agentSystemConfig, rustTavernSettingsConfig];
