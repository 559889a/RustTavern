...
} from '../../../scripts/app/chat/transport.js';
import { payloadToJsonl } from '../../../scripts/app/chat/jsonl.js';
import { jsonResponseNoCopy } from '../http-utils.js';
...
export function registerChatRoutes(router, context, { jsonResponse }) {
    ...
    router.post('/api/chats/get', async ({ body }) => {
        ...
        try {
            ...
            // Built per request by jsonlStreamToPayload -- nobody else holds it.
            return jsonResponseNoCopy(payload);
        } catch (error) {
            return jsonResponse(
                {
