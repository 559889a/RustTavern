...
const CONTROLLER_KEY = '__RUSTTAVERN_MOBILE_OVERLAY_COMPAT__';
...
export function installMobileOverlayCompatController() {
    ...
    if (typeof MutationObserver !== 'function') {
        throw new Error('[RustTavern] MutationObserver unavailable while installing mobile overlay compat controller.');
    }
    ...
    const start = () => {
        ...
        if (!(document.body instanceof HTMLBodyElement)) {
            throw new Error('[RustTavern] document.body unavailable while installing mobile overlay compat controller.');
        }
