...
const CONTROLLER_KEY = '__RUSTTAVERN_ANDROID_IME_LAYOUT_HOST__';
...
function requireHTMLElement(id) {
    ...
    if (!(element instanceof HTMLElement)) {
        throw new Error(`[RustTavern] #${id} unavailable while installing Android IME layout host.`);
    }
...
export function installAndroidImeLayoutHost() {
    ...
    if (typeof MutationObserver !== 'function') {
        throw new Error('[RustTavern] MutationObserver unavailable while installing Android IME layout host.');
    }
