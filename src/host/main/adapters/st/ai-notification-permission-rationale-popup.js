...
function buildPopupContent() {
    ...
    title.textContent = translateSillyTavern(
        'rusttavern_notification_permission_rationale_title',
        'Enable notifications?',
    );

    const body = document.createElement('div');
    body.textContent = translateSillyTavern(
        'rusttavern_notification_permission_rationale_body',
...
export async function confirmAiNotificationPermissionRationale() {
    ...
    const okButton = translateSillyTavern(
        'rusttavern_notification_permission_rationale_allow',
        'Enable',
    );
    const cancelButton = translateSillyTavern(
        'rusttavern_notification_permission_rationale_cancel',
        'Not now',
    );
