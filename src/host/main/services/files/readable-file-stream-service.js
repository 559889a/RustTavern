...
function normalizeFsReadResponse(data) {
    ...
    // Server mode (current): the command response is a base64 string with the
    // same 8-byte big-endian trailer the native bridge appends.
    ...
    // Server mode (legacy): JSON number array with the 8-byte trailer.
