import { getChatSurfaceParticipantRegistry } from '../host/main/services/chat-surface/runtime.js';
...
const PREVIEW_MESSAGE_TYPE = 'rusttavern_html_code_preview_height';
...
export function createHtmlCodePreviewParticipant({
    ...
    return Object.freeze({
        id: 'rusttavern/html-code-preview',
        protocolVersion: 1,
