...
function updateUiAudioPlayState() {
    const enabled = extension_settings.tts.enabled == true;
    const menuItem = $('#ttsExtensionMenuItem');
    if (enabled) {
        ...
        const mediaControl = $('#tts_media_control');
        if (mediaControl.attr('class') != img) {
            mediaControl.attr('class', img);
        }
    } else {
        if (menuItem.css('display') != 'none') {
            menuItem.hide();
