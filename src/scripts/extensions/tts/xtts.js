...
class XTTSTtsProvider {
    ...
    async loadSettings(settings) {
        ...
        // Stop polling after a minute even if the Extras module never
        // appears, so reloading settings can't stack live intervals.
        setTimeout(() => clearInterval(apiCheckInterval), 60000);
