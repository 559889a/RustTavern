...
export const NATIVE_CAPTION_UNAVAILABLE_MESSAGE = 'Image captioning is not implemented in the RustTavern native backend.';
        ...
        try {
            switch (selectedApiMap.selected) {
                ...
                case 'textgenerationwebui': {
                    ...
                    if (globalThis.__TAURI_RUNNING__ === true) {
                        throw new Error('Text Completion profiles are not supported by the native RustTavern generation backend yet. Use a Chat Completion profile.');
                    }
