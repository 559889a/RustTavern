...
import { subscribeAgentProfilesChanged } from '../../../rusttavern/agent/agent-profile-events.js';
import { AGENT_MODEL_REQUIRES_CONFIGURATION, sanitizePortableAgentProfile } from '../../../rusttavern/agent/agent-profile-portable.js';
import { normalizeAgentSystemPrompt } from '../../../rusttavern/agent/agent-system-prompt.js';
import { subscribeLlmConnectionsChanged } from '../../../rusttavern/agent/llm-connection-events.js';
                ...
                <header class="ttas-titlebar">
                    <div class="ttas-titlebar-main">
                        ...
                        <div class="ttas-title-copy">
                            <div class="ttas-eyebrow">{{ tr('rustTavernAgent') }}</div>
