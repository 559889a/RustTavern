...
export function createExtensionAssetLoader({
    ...
    async function addExtensionStyle(name, manifest) {
        ...
        if (existing) {
            if (existing.dataset.rusttavernLoaded === 'true') {
                return;
            }
        ...
        await new Promise((resolve, reject) => {
            ...
            const timeoutId = setTimeout(() => {
                ...
                settled = true;
                link.dataset.rusttavernLoaded = 'false';
            ...
            link.onload = function () {
                ...
                settled = true;
                clearTimeout(timeoutId);
                link.dataset.rusttavernLoaded = 'true';
                resolve();
            };
    ...
    async function addExtensionScript(name, manifest) {
        ...
        const loaded = new Promise((resolve, reject) => {
            script.onerror = function (err) {
                script.dataset.rusttavernLoaded = 'false';
        ...
        script.dataset.rusttavernLoaded = 'true';
    }
