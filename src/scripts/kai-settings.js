...
export function initKoboldSettings() {
    sliders.forEach(slider => {
        // Direct binding: these inputs are static in index.html (the no-op placeholder
        // resolves to nothing and jQuery skips it). Document-level delegation taxed
        // every input event on the page with a closest() match per entry.
