...
} from '../../../host/main/adapters/embedded-runtime/message-render-transaction.js';
import { syncElementAttributes } from './mes-text-content.js';
import { isEmbeddedRuntimeTakeoverDisabled } from '../../../host/main/services/embedded-runtime/embedded-runtime-profile-state.js';
import { getInstalledChatSurfaceController } from '../../../host/main/services/chat-surface/runtime.js';
import { isChatVirtualizationEnabled } from '../../../host/main/services/chat-surface/chat-virtualization-state.js';
...
/**
 * Replaces `.mes_text` HTML using the active RustTavern runtime policy.
 *
