...
import { DYNAMIC_THEME_CHANGED_EVENT } from '../../../../host/main/services/dynamic-theme/constants.js';
import { syncNativeRegexBackendEnabledFromSettings } from '../../regex/native-regex-settings.js';

/**
 * @param {ReturnType<import('./settings-patch.js').buildRustTavernSettingsUpdate>} update
 * @param {Record<string, any>} updatedSettings
 */
export function applyRustTavernSettingsUpdateEffects(update, updatedSettings) {
    ...
    if (changes.panelRuntimeProfile) {
        ...
        // - src/host/main/services/panel-runtime/install.js
        //
