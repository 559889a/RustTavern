...
import { normalizeEmbeddedRuntimeProfileName } from '../../../../host/main/services/embedded-runtime/embedded-runtime-profile-state.js';
...
/**
 * @param {ReturnType<import('./settings-state.js').createRustTavernSettingsState>} initial
 * @param {Record<string, any>} draft
 */
export function buildRustTavernSettingsUpdate(initial, draft) {
