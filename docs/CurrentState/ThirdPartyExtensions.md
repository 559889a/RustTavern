...
4. 返回真实 bytes、正确 `Content-Type`、`Cache-Control: private, no-cache`、weak ETag 和 Last-Modified；条件命中返回 `304 Not Modified`（见 `docs/CurrentState/HostResourceCaching.md`）
