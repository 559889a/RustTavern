...
| [AgentArchitecture.md](AgentArchitecture.md)、[AgentContract.md](AgentContract.md) | Agent 框架设计与契约 |
| [CurrentState/](CurrentState/README.md) | 各模块已落地的实现状态 |
| [HttpServerMigrationPlan.md](HttpServerMigrationPlan.md) | HTTP 服务器化迁移计划（历史） |
