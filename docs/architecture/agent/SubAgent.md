# RustTavern SubAgent Runtime

本文档记录当前 return-mode SubAgent 的实现基线、核心契约、Agent-friendly 设计原则与代码定位。`agent.handoff` 使用同一套 `AgentTaskRecord + AgentInvocation` 地基，但属于 foreground 接力流程；handoff 细节以 `docs/architecture/agent/Handoff.md` 为准。后续开发多 Agent、task cancel 与 invocation-scoped prompt assembly 前，应先读本文和 `Handoff.md`。
...
对 RustTavern 来说，SubAgent 的价值不是让多个模型抢写同一个回复，而是让主写作 Agent 低摩擦地请求设定检查、剧情漏洞审阅、风格建议、候选片段、摘要与局部研究。
...
当前 domain model 位于 `crates/tt-domain/src/models/agent/mod.rs`：
...
```text
crates/tt-ports/src/repositories/agent_invocation_repository.rs
crates/tt-adapter-storage-userdata/src/repositories/file_agent_repository/invocation_store.rs
```
...
当前 canonical 工具声明位于 `crates/tt-application/src/services/agent_tools/agent/descriptors.rs`：
...
```text
crates/tt-application/src/services/agent_runtime_service/delegation/policy.rs
crates/tt-application/src/services/agent_runtime_service/delegation/child_runtime.rs
crates/tt-application/src/services/agent_runtime_service.rs
```
...
```text
crates/tt-application/src/services/agent_runtime_service/delegation/rendering.rs
```
...
- 不把 `taskId`、`invocationId`、`profileId`、`inside RustTavern` 等运行时细节塞给模型。
...
```text
crates/tt-application/src/services/agent_runtime_service/delegation/workspace_policy.rs
```
...
```text
crates/tt-application/src/services/agent_runtime_service/delegation.rs
crates/tt-application/src/services/agent_runtime_service/delegation/list_tool.rs
crates/tt-application/src/services/agent_runtime_service/delegation/delegate_tool.rs
crates/tt-application/src/services/agent_runtime_service/delegation/handoff_tool.rs
crates/tt-application/src/services/agent_runtime_service/delegation/await_tool.rs
crates/tt-application/src/services/agent_runtime_service/delegation/task_return_tool.rs
crates/tt-application/src/services/agent_runtime_service/delegation/child_runtime.rs
crates/tt-application/src/services/agent_runtime_service/delegation/policy.rs
crates/tt-application/src/services/agent_runtime_service/delegation/rendering.rs
crates/tt-application/src/services/agent_runtime_service/delegation/workspace_policy.rs
crates/tt-application/src/services/agent_runtime_service/scheduler.rs
crates/tt-application/src/services/agent_runtime_service/invocation.rs
crates/tt-application/src/services/agent_runtime_service/tool_execution.rs
```

Tool registry / dispatcher：

```text
crates/tt-application/src/services/agent_tools/agent/descriptors.rs
crates/tt-application/src/services/agent_tools/registry.rs
crates/tt-application/src/services/agent_tools/dispatcher.rs
```

Profile / policy：

```text
crates/tt-domain/src/models/agent/profile.rs
crates/tt-application/src/services/agent_profile_service.rs
crates/tt-adapter-storage-userdata/src/repositories/file_agent_profile_repository/mod.rs
```
...
```text
crates/tt-application/src/services/agent_runtime_service/tests.rs
crates/tt-adapter-storage-userdata/src/repositories/file_agent_repository/tests.rs
```
