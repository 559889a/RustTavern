...
use tt_domain::models::settings::{
    ...
    SettingsSnapshot, StartupUpdatePopupSettings, RustTavernSettings, RustTavernUpdateSettings,
    UserSettings,
};
use tt_domain::models::update::UpdateChannel;

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RustTavernSettingsDto {
    pub updates: RustTavernUpdateSettingsDto,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RustTavernUpdateSettingsDto {
    #[serde(default)]
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct UpdateRustTavernSettingsDto {
    pub updates: Option<RustTavernUpdateSettingsDto>,
...
pub struct SillyTavernSettingsResponseDto {
    pub settings: String,
    pub rusttavern_settings_revision: UserSettingsRevisionDto,
...
impl From<RustTavernSettings> for RustTavernSettingsDto {
    fn from(settings: RustTavernSettings) -> Self {
        Self {
            updates: RustTavernUpdateSettingsDto::from(settings.updates),
...
impl From<RustTavernUpdateSettings> for RustTavernUpdateSettingsDto {
    fn from(settings: RustTavernUpdateSettings) -> Self {
        Self {
