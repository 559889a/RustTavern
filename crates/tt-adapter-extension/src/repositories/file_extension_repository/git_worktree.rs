...
fn apply_ref_edits(
    ...
    let signature = gix::actor::Signature {
        name: "RustTavern".into(),
        email: "noreply@rusttavern.local".into(),
...
mod tests {
    ...
    fn write_commit(
        ...
        let tree = repo
            ...
            .detach();
        let signature = gix::actor::Signature {
            name: "RustTavern Test".into(),
            email: "test@rusttavern.local".into(),
            time: gix::date::Time::now_utc(),
        };
