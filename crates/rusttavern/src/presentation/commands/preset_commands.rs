...
pub async fn save_preset(
    dto: SavePresetDto,
    state: Arc<AppState>) -> Result<SavePresetResponseDto, CommandError> {
...
pub async fn restore_preset(
    ...
    state: Arc<AppState>) -> Result<RestorePresetResponseDto, CommandError> {
...
pub async fn delete_openai_preset(
    ...
    state: Arc<AppState>) -> Result<DeleteOpenAIPresetResponseDto, CommandError> {
...
pub async fn list_presets(
    api_id: String,
    state: Arc<AppState>) -> Result<Vec<String>, CommandError> {
...
pub async fn preset_exists(
    name: String,
    api_id: String,
    state: Arc<AppState>) -> Result<bool, CommandError> {
...
pub async fn get_preset(
    name: String,
    api_id: String,
    state: Arc<AppState>) -> Result<Option<Value>, CommandError> {
