...
pub struct AppState {
    ...
    /// Host-bound handles used by presentation commands.
...
impl AppState {
    pub(crate) async fn new(
        ...
        tracing::info!(
            "Initializing application with data root: {:?}",
        ...
        let services =
            composition::build_services(&app_context, &data_directory, &startup_profile).await?;
