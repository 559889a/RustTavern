...
use crate::infrastructure::logging::llm_api_logs::LoggingChatCompletionRepository;
...
pub(super) async fn build(
    ...
    let llm_api_log_store = app_context.llm_api_log_store.clone();
