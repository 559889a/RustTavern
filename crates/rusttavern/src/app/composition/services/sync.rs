...
pub(super) fn build(
    ...
    let sync_job_events = adapters::sync_job_events(app_context);
    let pairing_approval = adapters::pairing_approval(app_context);
    ...
    let sync_automation_service = Arc::new(SyncAutomationService::new(
        adapters::sync_automation_events(app_context),
