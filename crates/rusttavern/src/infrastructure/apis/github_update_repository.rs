...
const GITHUB_API_LATEST_RELEASE: &str =
    "https://api.github.com/repos/559889a/RustTavern/releases/latest";
const GITHUB_API_CANARY_RELEASE: &str =
    "https://api.github.com/repos/559889a/RustTavern/releases/tags/Canary";
const GITHUB_API_CANARY_COMMIT: &str =
    "https://api.github.com/repos/559889a/RustTavern/commits/Canary";
