...
pub struct FilePresetRepository {
    /// Resource roots for reading bundled default presets
...
impl FilePresetRepository {
    ...
    ///
    /// * `resources` - resource roots for reading bundled default presets
        ...
        for item in content_items {
                ...
                && item_type == *preset_type
            {
                ...
                if item_name == name {
                    ...
                    let data: Value = self.resources.read_json(&format!(
                        "default/content/{}",
                        item.filename
                    ))?;
