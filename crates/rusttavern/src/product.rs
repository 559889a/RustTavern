...
pub(crate) const USER_AGENT: &str = concat!("RustTavern/", env!("CARGO_PKG_VERSION"));
pub(crate) const GIT_REVISION: &str = env!("RUSTTAVERN_GIT_REVISION");
pub(crate) const GIT_BRANCH: &str = env!("RUSTTAVERN_GIT_BRANCH");
