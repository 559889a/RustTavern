...
impl AssetRepository for FileAssetRepository {
    ...
    async fn commit_staged_asset_file(
        ...
        // Same-volume rename: a copy here could be interrupted halfway and
        // leave a truncated file at the target with the temp already removed.
        crate::file_system::replace_file_with_fallback(&temp_path, &target_path).await?;
