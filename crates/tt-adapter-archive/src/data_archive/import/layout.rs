...
struct ArchiveRootStats {
    ...
    has_rusttavern_state_root: bool,
...
fn record_archive_root_candidate(
    ...
    if first == "_tauritavern" {
        stats.has_rusttavern_state_root = true;
    }
...
fn layout_policy_candidates_for_root(
    ...
    let has_data_root_feature =
        stats.has_rusttavern_state_root || stats.has_global_extensions_root;
...
mod tests {
    ...
    #[test]
    fn detects_rusttavern_data_root_layout() {
